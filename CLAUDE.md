...
- **Push back when something is wrong** — if the user asks for something that introduces code smells, breaks separation of concerns, or duplicates existing logic, say so bluntly. Explain why and suggest the correct approach. The user respects honest technical disagreement.
